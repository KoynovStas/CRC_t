...
std::vector<AbstractProxy_CRC_t *> get_crc_list()
{
    ...
    ADD_CRC_TO_LIST("CRC-8/HITAG",      8, 0x1D, 0xFF, false, false, 0x0,  0xB4);
    ...
    ADD_CRC_TO_LIST("CRC-16//M17",             16, 0x5935, 0xFFFF, false, false, 0x0,    0x772B);
    ...
    ADD_CRC_TO_LIST("CRC-64/MS",       64, 0x259C84CBA6426349, 0xFFFFFFFFFFFFFFFF, true,  true,  0x0,                0x75D4B74F024ECEEA);
    ADD_CRC_TO_LIST("CRC-64/REDIS",    64, 0xAD93D23594C935A9, 0x0,                true,  true,  0x0,                0xE9C6D914C4B8D9CA);
